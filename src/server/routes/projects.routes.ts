...
import { getTasks, getAllTasks, createTask } from "@/server/controllers/tasks.controller";
...
router.get("/:projectId/scenes", getScenes);
router.get("/:projectId/tasks", getAllTasks);
router.get("/:projectId/scenes/:sceneId/tasks", getTasks);
